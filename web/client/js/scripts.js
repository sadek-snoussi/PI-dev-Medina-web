...
jQuery(function ($) {
    ...
    $(".flex-control-nav").prepend('<a class="prev" href="http://templines.rocks/"><span class="fa fa-chevron-left"></span></a>');
    $(".flex-control-nav").append('<a class="next" href="http://templines.rocks/"><span class="fa fa-chevron-right"></span></a>');
